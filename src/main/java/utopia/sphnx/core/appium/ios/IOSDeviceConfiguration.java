package utopia.sphnx.core.appium.ios;

import utopia.sphnx.core.appium.manager.ConfigFileManager;
...
public class IOSDeviceConfiguration {
    ...
    public void setValidDevices(List<String> deviceID) {
        deviceID.forEach(deviceList -> {
            if (deviceList.length() == utopia.sphnx.core.appium.ios.IOSDeviceConfiguration.IOS_UDID_LENGTH) {
