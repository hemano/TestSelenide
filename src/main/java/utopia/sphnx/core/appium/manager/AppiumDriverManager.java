...
import utopia.sphnx.core.appium.utils.DesiredCapabilityBuilder;
...
public class AppiumDriverManager {
    ...
    public void startAppiumDriverInstance(Optional<DesiredCapabilities> iosCaps,
        ...
        if (ConfigFileManager.configFileMap.get("APP_TYPE").equalsIgnoreCase("web")) {
            ...
            utopia.sphnx.core.appium.manager.AppiumDriverManager.setDriver(currentDriverSession);
        } else {
    ...
    public void stopAppiumDriver() throws IOException, InterruptedException {
        ...
        if (utopia.sphnx.core.appium.manager.AppiumDriverManager.getDriver() != null) {
            utopia.sphnx.core.appium.manager.AppiumDriverManager.getDriver().quit();
        }
    }
