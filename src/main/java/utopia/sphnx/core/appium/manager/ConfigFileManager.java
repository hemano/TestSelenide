...
public class ConfigFileManager {
    ...
    private static utopia.sphnx.core.appium.manager.ConfigFileManager instance;
    ...
    public static utopia.sphnx.core.appium.manager.ConfigFileManager getInstance() throws IOException {
        if (instance == null) {
            ...
            try {
                ...
                instance = new utopia.sphnx.core.appium.manager.ConfigFileManager(configFile);
