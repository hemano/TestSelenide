...
import org.testng.*;
import utopia.sphnx.core.appium.annotation.values.Description;
import utopia.sphnx.core.appium.annotation.values.SkipIf;
...
public final class AppiumParallelTestListener
    ...
    public void beforeInvocation(IInvokedMethod method, ITestResult testResult) {
        ...
        if (method.getTestMethod().isBeforeClassConfiguration() &&
                !method.getTestMethod().getMethodName().equals("springTestContextBeforeTestClass")
                && !method.getTestMethod().getMethodName().equals("springTestContextPrepareTestInstance")) {
    ...
    */
    ...
    public void onFinish(ISuite iSuite) {
        ...
        try {
            ...
            metaData.put("userMetaData", (Object) userLogs);
